...
public:
    ...
    void computeNew(const tMesh & mesh, Eigen::VectorXd & gauss, Eigen::VectorXd & mean, Eigen::VectorXd & PrincCurv1, Eigen::VectorXd & PrincCurv2) const;
    void computeDir(const tMesh & mesh, Eigen::VectorXd & gauss, Eigen::VectorXd & mean, Eigen::VectorXd & PrincCurv1, Eigen::VectorXd & PrincCurv2, Eigen::VectorXd & CurvY, Eigen::VectorXd & CurvX, Eigen::Vector3d & DirX, Eigen::Vector3d & DirY) const;
    void computePrincGrowthDir(const tMesh & mesh, Eigen::VectorXd & gauss, Eigen::VectorXd & mean, Eigen::VectorXd & PrincCurv1, Eigen::VectorXd & PrincCurv2, Eigen::VectorXd & CurvX, Eigen::VectorXd & CurvY, Eigen::MatrixXd & PrincGrowthDir1, Eigen::MatrixXd & PrincGrowthDir2) const;
};
